...
namespace Hatchery.Framework.Network
{
    ...
    {
        public static int MaxPacketSize = 64 * 1024;
        ...
        private void IO_Complete(object sender, object o)
        {
            ...
            LoggerHelper.Info(0, String.Format("Session IO_Complete {0}", args.LastOperation));
        ...
        private void OnConnectComplete(object o)
        {
            ...
            {
                Hatchery.Framework.Utility.LoggerHelper.Info(0,"status is not connecting");
                return;
            }
